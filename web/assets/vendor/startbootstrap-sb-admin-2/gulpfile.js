...
gulp.task('copy', function() {
    gulp.src(['../bootstrap/dist/**/*', '!**/npm.js', '!**/bootstrap-theme.*', '!**/*.map'])
        .pipe(gulp.dest('vendor/bootstrap'))

    gulp.src(['../bootstrap-social/*.css', '../bootstrap-social/*.less', '../bootstrap-social/*.scss'])
        .pipe(gulp.dest('vendor/bootstrap-social'))

    gulp.src(['../datatables/media/**/*'])
        .pipe(gulp.dest('vendor/datatables'))

    gulp.src(['../datatables-plugins/integration/bootstrap/3/*'])
        .pipe(gulp.dest('vendor/datatables-plugins'))

    gulp.src(['../datatables-responsive/css/*', 'bower_components/datatables-responsive/js/*'])
        .pipe(gulp.dest('vendor/datatables-responsive'))

    gulp.src(['../flot/*.js'])
        .pipe(gulp.dest('vendor/flot'))

    gulp.src(['../flot.tooltip/js/*.js'])
        .pipe(gulp.dest('vendor/flot-tooltip'))

    gulp.src(['../font-awesome/**/*', '!../font-awesome/*.json', '!../font-awesome/.*'])
    ...
    gulp.src(['../morrisjs/*.js', '../morrisjs/*.css', '!../morrisjs/Gruntfile.js'])
        .pipe(gulp.dest('vendor/morrisjs'))

    gulp.src(['../raphael/raphael.js', '../raphael/raphael.min.js'])
